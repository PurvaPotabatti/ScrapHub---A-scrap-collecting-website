        ...
        <div class="container py-5">
            ...
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a class="text-white" href="index.categories" >Categories</a></li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="container">
            ...
            <div class="row g-4">
                <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item">
                        <div class="overflow-hidden">
                            <img class="img-fluid" src="img/service-1_new.jpg" style="width:2100px; height:250px"alt="">
                        </div>
                ...
                <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item">
                        <div class="overflow-hidden">
                            <img class="img-fluid" src="img/service-2_new.jpg" style="width:2100px; height:250px"alt="">
                        </div>
                        <div class="p-4 text-center border border-5 border-light border-top-0">
                ...
                <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="service-item">
                        <div class="overflow-hidden">
                            <img class="img-fluid" src="img/service-3_new.webp" style="width:2100px; height:250px"alt="">
                        </div>
                        <div class="p-4 text-center border border-5 border-light border-top-0">
                ...
                <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item">
                        <div class="overflow-hidden">
                            <img class="img-fluid" src="img/service-4_new.jpg" style="width:2100px; height:250px"alt="">
                        </div>
                        <div class="p-4 text-center border border-5 border-light border-top-0">
                ...
                <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item">
                        <div class="overflow-hidden">
                            <img class="img-fluid" src="img/service-5_new.jpg" style="width:2100px; height:250px"alt="">
                        </div>
                        <div class="p-4 text-center border border-5 border-light border-top-0">
                ...
                <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="service-item">
                        <div class="overflow-hidden">
                            <img class="img-fluid" src="img/service-6_new.jpg" style="width:2100px; height:250px"alt="">
                        </div>
                        <div class="p-4 text-center border border-5 border-light border-top-0">
                ...
                <div class="col-lg-6 quote-text py-5 wow fadeIn" data-wow-delay="0.5s">
                    <div class="p-lg-5 pe-lg-0">
                        <div class="section-title text-start">
                            <h1 class="display-5 mb-4" style="color:#03AC13 !important">Free Quote</h1>
                        </div>
                        ...
                        <form>
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    <button style="background-color:#03AC13 !important" class="btn btn-primary w-100 py-3" type="submit">Submit</button>
                                </div>
                            </div>
                        </form>
                    </div>
            ...
            <div class="owl-carousel testimonial-carousel">
                <div class="testimonial-item text-center">
                    ...
                    <div class="testimonial-text text-center p-4">
                        ...
                        <h5 class="mb-1" style="color:#03AC13 !important">Client Name</h5>
