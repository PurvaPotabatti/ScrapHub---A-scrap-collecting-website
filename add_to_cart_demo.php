                    ...
                    if (isset($value['Scrap_name'])) {
                        ...
                        <div id="cartContainer" class="d-sm-flex justify-content-between my-4 pb-4 border-bottom">
                            <div class="media d-block d-sm-flex text-center text-sm-left">
                                <a class="cart-item-thumb mx-auto mr-sm-4" href="#"><img src="<?php echo $value['Image']; ?>" width="240" height="150" alt="Product"></a>
                            ...
                            <div class="pt-2 pt-sm-0 pl-sm-3 mx-auto mx-sm-0 text-center text-sm-left" style="max-width: 10rem;">
                                ...
                                <!--<form action="upload_images.php" method="POST" enctype="multipart/form-data">
                                    <input type="hidden" name="scrap_name" value="<?php echo $value['Scrap_name']; ?>">
